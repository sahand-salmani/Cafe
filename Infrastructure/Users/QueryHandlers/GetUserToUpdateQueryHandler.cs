...
{
    public class GetUserToUpdateQueryHandler : IRequestHandler<GetUserToUpdateQuery, EditUserVm>
    {
        ...
        public async Task<EditUserVm> Handle(GetUserToUpdateQuery request, CancellationToken cancellationToken)
        {
